...
type ThanosRulerSpec struct {
	...
	// PrometheusRuleOrRuleConfigMapSelector is the label selector to discover ConfigMaps with rule files.
	...
	// +kubebuilder:default:={matchLabels:{"operator.thanos.io/rule-filee": "true"}}
	// +kubebuilder:validation:Required
	...
	PrometheusRuleOrRuleConfigMapSelector *metav1.LabelSelector `json:"ruleConfigSelector,omitempty"`
